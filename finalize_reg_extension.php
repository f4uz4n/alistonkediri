<?php
// finalize_registration_and_details.php

// 1. Update register.php (Full Detailed Version)
$register_path = 'app/Views/agency/register.php';
$register_content = <<<'EOD'
        ...
        <form action="<?= base_url('agency/store-registration') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-header bg-info text-white py-4 px-4">
                    <h5 class="fw-bold mb-0"><i class="bi bi-passport me-2"></i>Informasi Paspor (Opsional)</h5>
                </div>
                <div class="card-body p-4 p-md-5">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-secondary text-uppercase ls-1">Nomor Paspor</label>
                            <input type="text" name="passport_number" class="form-control form-control-lg bg-light border-0 rounded-3" placeholder="A 1234567">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-secondary text-uppercase ls-1">Kota Penerbitan</label>
                            <input type="text" name="passport_issuance_city" class="form-control form-control-lg bg-light border-0 rounded-3" placeholder="cth: Jakarta Selatan">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-secondary text-uppercase ls-1">Tanggal Pengeluaran</label>
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-header bg-warning text-dark py-4 px-4">
                    <h5 class="fw-bold mb-0"><i class="bi bi-exclamation-octagon-fill me-2"></i>Kontak Darurat (Opsional)</h5>
                </div>
                <div class="card-body p-4 p-md-5">
                    <div class="row g-4">
                        <div class="col-md-5">
                            <label class="form-label small fw-bold text-secondary text-uppercase ls-1">Nama Kontak Darurat</label>
                            <input type="text" name="emergency_name" class="form-control form-control-lg bg-light border-0 rounded-3">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label small fw-bold text-secondary text-uppercase ls-1">Hubungan</label>
                            <input type="text" name="emergency_relationship" class="form-control form-control-lg bg-light border-0 rounded-3" placeholder="cth: Anak">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small fw-bold text-secondary text-uppercase ls-1">Nomor Telepon Darurat</label>
                            <input type="text" name="emergency_phone" class="form-control form-control-lg bg-light border-0 rounded-3">
                        </div>
                    </div>
                </div>
            </div>
...
<?= $this->endSection() ?>
EOD;
file_put_contents($register_path, $register_content);

echo "FINAL RESTORATION: register.php, Agency.php methods, and edit_participant.php confirmed active.\n";
?>
EOD;
