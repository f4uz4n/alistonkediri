        ...
        <form action="<?= base_url('owner/tabungan/store-deposit') ?>" method="post" enctype="multipart/form-data" class="card border-0 shadow-sm rounded-4 p-4 mb-4">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="amount" class="form-control form-control-lg bg-light border-0" required placeholder="Contoh: 5000000" value="<?= esc(old('amount')) ?>">
                </div>
                <div class="col-md-6">
                ...
                <ul class="list-unstyled mb-0">
                    <?php foreach ($deposits as $d): ?>
                        <li class="d-flex justify-content-between align-items-center py-2 border-bottom">
                            ...
                            <strong>Rp <?= number_format($d['amount'], 0, ',', '.') ?></strong>
                        </li>
                    <?php endforeach; ?>
                </ul>
            <?php endif; ?>
