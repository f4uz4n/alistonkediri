...
<div class="row justify-content-center">
    <div class="col-12 col-lg-8">
        ...
        <?php endif; ?>
        <form action="<?= base_url('owner/tabungan/update/' . (int)($s['id'] ?? 0)) ?>" method="post" class="card border-0 shadow-sm rounded-4 p-4">
            <?= csrf_field() ?>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control form-control-lg bg-light border-0" required minlength="3" value="<?= esc(old('name', $s['name'] ?? '')) ?>" placeholder="Nama sesuai KTP">
            </div>
            <div class="row g-3">
                <div class="col-md-6">
